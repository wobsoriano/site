...
const about = () => {
    ...
    if (!data) return <div className="flex justify-center items-center" style={{ height: '60vh' }}><RotateSpinner size={60} color="#64ffda" loading={data} /></div>;
        ...
        <div className="container">
            <div className="w-full px-4 md:px-6 text-xl leading-normal">
                ...
                {sortByStars.map((item, idx) => (
                    <div className="w-full flex items-stretch lg:w-1/2 px-2 mb-4" key={idx}>
